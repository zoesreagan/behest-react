...
class UserFormContainer extends Component {
  ...
  getFormByUser = async () => {
    const formJson = await fetch('https://powerful-plateau-54403.herokuapp.com/form', {
      credentials: 'include'
    });
...
//create the form
  createForm = async (dateCreated, responseOne, responseTwo, responseThree, responseFour, responseFive, responseSix, responseSeven, responseEight, responseNine) => {
    ...
    const form = await fetch('https://powerful-plateau-54403.herokuapp.com/form', {
      method: 'POST',
      credentials: 'include',
      body: JSON.stringify({
...
//edit the form
    editForm = async (dateCreated, responseOne, responseTwo, responseThree, responseFour, responseFive, responseSix, responseSeven, responseEight, responseNine) => {
      ...
      const form = await fetch('https://powerful-plateau-54403.herokuapp.com/form/' + id, {
        method: 'PUT',
        credentials: 'include',
        body: JSON.stringify({
          date_created: dateCreated,
                ...
                <AddNewForm addedForm={this.state.addedForm} createForm={this.createForm} navigateToIndex={this.navigateToIndex} />
                 : <div>
                   {this.props.showFormIndex ?
                     <FormIndex form={this.state.form} deleteForm={this.deleteForm} renderEditForm={this.props.renderEditForm} editedFormId={this.props.editedFormId} getFormToEdit={this.props.getFormToEdit} formToEdit={this.props.formToEdit} deleteForm={this.props.deleteForm} />
                     :<div>
