...
class App extends Component {
  ...
  logout = async (username, password) => {
    const userLogout = await fetch('https://powerful-plateau-54403.herokuapp.com/user/logout', {
    });
  ...
  getFormToEdit = async () => {
    ...
    const formJson = await fetch('https://powerful-plateau-54403.herokuapp.com/form/' + id, {
      credentials: 'include'
    });
